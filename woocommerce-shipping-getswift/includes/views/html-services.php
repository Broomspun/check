<tr valign="top" id="service_options">
	<th scope="row" class="titledesc"><?php _e( 'Services', 'woocommerce-shipping-getswift' ); ?></th>
	<td class="forminp">
		<table class="fedex_services widefat">
			<thead>
				<th class="sort">&nbsp;</th>
				<th><?php _e( 'Service Code', 'woocommerce-shipping-getswift' ); ?></th>
				<th><?php _e( 'Name', 'woocommerce-shipping-getswift' ); ?></th>
				<th><?php _e( 'Enabled', 'woocommerce-shipping-getswift' ); ?></th>
				<th><?php echo sprintf( __( 'Price Adjustment (%s)', 'woocommerce-shipping-getswift' ), get_woocommerce_currency_symbol() ); ?></th>
				<th><?php _e( 'Price Adjustment (%)', 'woocommerce-shipping-getswift' ); ?></th>
			</thead>
			<tbody>
				<?php
					$sort = 0;
