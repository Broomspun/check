<tr valign="top" id="packing_options">
	<th scope="row" class="titledesc"><?php _e( 'Box Sizes', 'woocommerce-shipping-getswift' ); ?></th>
	<td class="forminp">
		<style type="text/css">
		...
		<table class="fedex_boxes widefat">
			<thead>
				<tr>
					...
					<th><?php _e( 'Name', 'woocommerce-shipping-getswift' ); ?></th>
					<th><?php _e( 'Length', 'woocommerce-shipping-getswift' ); ?></th>
					<th><?php _e( 'Width', 'woocommerce-shipping-getswift' ); ?></th>
					<th><?php _e( 'Height', 'woocommerce-shipping-getswift' ); ?></th>
					<th><?php _e( 'Weight of Box', 'woocommerce-shipping-getswift' ); ?></th>
					<th><?php _e( 'Max Weight', 'woocommerce-shipping-getswift' ); ?></th>
					<th><?php _e( 'Enabled', 'woocommerce-shipping-getswift' ); ?></th>
				</tr>
			</thead>
			<tfoot>
				<tr>
					<th colspan="3">
						<a href="#" class="button plus insert"><?php _e( 'Add Box', 'woocommerce-shipping-getswift' ); ?></a>
						<a href="#" class="button minus remove"><?php _e( 'Remove selected box(es)', 'woocommerce-shipping-getswift' ); ?></a>
					</th>
					<th colspan="6">
						<small class="description"><?php _e( 'Items will be packed into these boxes depending based on item dimensions and volume. Dimensions will be passed to FedEx and used for packing. Items not fitting into boxes will be packed individually.', 'woocommerce-shipping-getswift' ); ?></small>
					</th>
				</tr>
			</tfoot>
			<tbody id="rates">
